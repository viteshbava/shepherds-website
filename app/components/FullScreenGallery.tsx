...
const FullscreenImage: React.FC<FullscreenImageProps> = ({ images, initialIndex, onClose }) => {
  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50'>
      ...
      <button className='custom-prev absolute left-0 text-white text-3xl z-50 p-4'>&#10094;</button>
      <button className='custom-next absolute right-0 text-white text-3xl z-50 p-4'>
        &#10095;
      </button>
