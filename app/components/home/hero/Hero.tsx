...
const Hero = () => {
  ...
  return (
    <Section id='hero' className={`${styles['hero-height']} justify-center gap-4 sm:gap-6 `}>
      ...
      <div className='flex flex-col flex-grow sm:flex-none sm:grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-12 md:p-8'>
        <div className='sm:aspect-square flex-grow'>
          <HeroImages images={images} altText='Shepherds of Cassini album artwork' />
        </div>
        <div className='sm:aspect-square flex flex-col justify-center'>
          <h3 className='text-lg sm:text-xl mb-2 sm:mb-3 gold-heading'>Listen | Purchase</h3>
